...
#!/usr/bin/env python3
"""
KanjiVG -> JSON polyline converter (with "char" field).
...
Usage examples:
  # Convert a single KanjiVG XML file that contains many <kanji> nodes:
  python kanjivg_to_json.py --input kanjivg.xml --out out/kanji.json --pretty --normalize

  # Convert a directory of per-kanji SVG/XML files:
  python kanjivg_to_json.py --input kanjivg/kanji --out out/ --per-kanji --pretty --normalize
