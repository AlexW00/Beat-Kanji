...
Beat Kanji is an iOS rhythm game prototype where players practice writing Kanji strokes to a beat.

## Features

- **Rhythm Gameplay**: Draw Kanji strokes in time with music. Includes a selection of classical and original tracks.
- **Stroke Evaluation**: Real-time scoring of drawn strokes against KanjiVG data using a distance-based algorithm.
- **Progression**: Stroke-by-stroke guidance with visual cues (Current, Completed, Future).
- **Feedback**: Immediate visual and score feedback (Perfect, Good, Miss).
- **Song Selection**: Browse and select songs with different difficulty levels.
...
Refer to `doc/` for detailed documentation:

- `beatmap.md`: Beatmap JSON format & integration.
- `beat-editor.md`: Beatmap Editor usage and features.
- `game-engine.md`: Game logic details.
- `play.screen.md`: Play scene architecture.
- `adding-songs.md`: Guide for adding new tracks.
- `ui-components.md`: Documentation for UI system.
...
![Beatmap Editor](doc/beatmap-editor.png)
